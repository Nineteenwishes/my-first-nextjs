...
const skills = ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'UI Design', 'Frontend Development'];

export default function Home() {
    return (
        <div className="min-h-screen bg-white text-black font-sans dark:bg-zinc-950 dark:text-white">
            {/* Navbar/Header Area */}
            <header role="banner" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-12 sm:pb-24">
            ...
            <main role="main" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row gap-8 sm:gap-12 md:gap-16 items-start">

                    {/* Left Column: Image - LCP Optimization */}
                    <div className="relative w-full md:w-[320px] aspect-[3/4] shrink-0 mx-auto md:mx-0">
                        <Image
                            src="/images/profile-dark.JPG"
                            alt="Foto profil Akbar Maulana, Web Developer profesional yang fokus pada Next.js dan React"
                            width={320}
                            height={427}
                    ...
                    <div className="flex-1 space-y-6 sm:space-y-8 pt-2 sm:pt-4">
                        ...
                        <section aria-labelledby="about-heading">
                            <h2 id="about-heading" className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">Tentang Saya</h2>
                        ...
                        <div className="h-px w-full bg-gray-300 my-6 sm:my-8" aria-hidden="true"></div>

                        {/* Section: Keahlian Utama */}
                        <section aria-labelledby="skills-heading">
                            <h3 id="skills-heading" className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Keahlian Utama</h3>
                            <ul className="flex flex-wrap gap-2.5 sm:gap-3" role="list" aria-label="Daftar keahlian">
                                {skills.map((skill) => (
                                    <li key={skill}>
                                        <span className="px-3 sm:px-4 py-2 bg-gray-100 rounded-full text-xs sm:text-sm font-medium text-gray-800 border border-gray-300 inline-block">
                                            {skill}
                                        </span>
                                    </li>
                                ))}
